...
#define PRE_UVLO	SMPL_WARN
#define PRE_OCP_CPU1	OCP_WARN_CPUCL1
#define PRE_OCP_CPU2	OCP_WARN_CPUCL2
#define SOFT_PRE_OCP_CPU1	SOFT_OCP_WARN_CPUCL1
#define SOFT_PRE_OCP_CPU2	SOFT_OCP_WARN_CPUCL2
#define PRE_OCP_TPU	OCP_WARN_TPU
#define PRE_OCP_GPU	OCP_WARN_GPU
#define SOFT_PRE_OCP_TPU	SOFT_OCP_WARN_TPU
#define SOFT_PRE_OCP_GPU	SOFT_OCP_WARN_GPU
#define USERSPACE	17
#define TRIGGERED_SOURCE_MAX	18
