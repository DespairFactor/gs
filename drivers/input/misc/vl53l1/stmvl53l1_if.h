 ...
 *
 * for multi instance all device 2nd and next instance are basic
 * name +"1"+"2"
...
enum __stmv53l1_parameter_name_e {
	 ...
	 *
	 * @warning dmax reflectance can only be set while not ranging
	 */
...
/**
 * Control the power of sensor
 */
#define VL53L1_IOCTL_POWER_UP _IO('p', 0x06)
#define VL53L1_IOCTL_POWER_DOWN _IO('p', 0x07)
